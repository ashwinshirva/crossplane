# ====================================================================================
# Setup Project
PROJECT_NAME := provider-ashprovider
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider AshProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider AshProvider controllers
...
# This target prepares repo for your provider by replacing all "ashprovider"
